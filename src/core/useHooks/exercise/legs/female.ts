    ...
    playlist: [
      {
        ...
        point: 2,
        link: bodyZones.legs.female.Glute_Bridge,
        duration: difficulty,
        completed: false,
        type: 'legs',
      },
    ...
    playlist: [
      {
        ...
        point: 2,
        link: bodyZones.legs.female.Hold_the_top_of_a_dumbbell,
        duration: difficulty,
        completed: false,
        type: 'legs',
      },
    ...
    playlist: [
      {
        ...
        point: 2,
        link: bodyZones.legs.female.Laying_down,
        duration: difficulty,
        completed: false,
        type: 'legs',
      },
    ...
    playlist: [
      {
        ...
        point: 2,
        link: bodyZones.legs.female.Lean_Leg_Workout_cove,
        duration: difficulty,
        completed: false,
        type: 'legs',
      },
      {
        ...
        point: 2,
        link: bodyZones.legs.female.burpees,
        duration: difficulty,
        completed: false,
        type: 'legs',
      },
